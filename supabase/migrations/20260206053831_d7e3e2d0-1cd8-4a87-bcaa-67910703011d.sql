-- Create optimized RPC for paginated leads listing
-- This avoids the slow 'exact' count and RLS overhead per row
...
BEGIN
  -- Check permissions ONCE at the start
  ...
  -- Permission check for specific client
  ...
  -- Get total count using estimated count for performance
