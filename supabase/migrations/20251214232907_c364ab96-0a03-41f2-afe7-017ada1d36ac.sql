-- Fix Recuperador Inteligente grouping: group by buyer_email + product only
-- Use MIN(computed_value) as the single purchase value

-- 1. Update get_transaction_stats
