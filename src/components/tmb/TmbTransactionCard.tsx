...
import { TmbTransaction } from '@/hooks/useTmbTransactions';

interface TmbTransactionCardProps {
  transaction: TmbTransaction;
  onClick: () => void;
}

export function TmbTransactionCard({ transaction, onClick }: TmbTransactionCardProps) {
  return (
